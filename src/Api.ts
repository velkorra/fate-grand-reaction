...
export const getServantsWhithLocalization = async (): Promise<
  ServantWhithLocalization[]
> => {
  try {
    const response = await axios.get<ServantWhithLocalization[]>(
      BASE_URL + "servants_list"
    );
...
export const getServantImage = async (
  servant_id: number,
  grade: number
): Promise<any> => {
...
export const createServant = async (servantData: any): Promise<any> => {
  const response = await axios.post(BASE_URL + "servants", servantData, {
    headers: {
...
export const addLocalization = async (
  formData: FormData,
  language: string,
  servant_id: number
): Promise<any> => {
...
export const getAciveContractsCount = async (
  master_id: number
): Promise<any> => {
  const response = await axios.get(
    BASE_URL + `masters/${master_id}/active_count`
  );
...
export const updateLocalization = async (
  servantLocalizationUpdate: ServantLocalization,
  language: string,
  servant_id: number
): Promise<any> => {
  const response = await axios.put(
    BASE_URL + "localization",
    servantLocalizationUpdate,
    {
      params: {
        language: language,
        servant_id: servant_id,
...
export const updateServant = async (
  servant: ServantUpdate,
  servant_id: number
): Promise<any> => {
  const response = await axios.put(
    BASE_URL + `servants/${servant_id}`,
    servant
  );
  return response;
};
...
export const updateNoblePhantasm = async (
...
export const createNoblePhantasm = async (
  noble_phantasm: NoblePhantasm
): Promise<any> => {
  try {
...
export const deleteNoblePhantasm = async (servant_id: number): Promise<any> => {
  try {
    const response = await axios.delete(BASE_URL + "np/" + servant_id);
    return response;
  } catch (error) {
    alert(error);
  }
...
export const addSkillPicture = async (
  formData: FormData,
  id: number
): Promise<any> => {
  const response = await axios.post(
    BASE_URL + `add_skill_picture/${id}`,
    formData,
    {
      headers: {
        "Content-Type": "multipart/form-data",
